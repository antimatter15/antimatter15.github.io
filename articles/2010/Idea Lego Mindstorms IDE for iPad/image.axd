...
<div class="content-container"> 
 <fieldset><h4>Detailed Error Information:</h4> 
  ...
  <div id="details-right"> 
   <table border="0" cellpadding="0" cellspacing="0"> 
    <tr class="alt"><th>Requested URL</th><td>&nbsp;&nbsp;&nbsp;http://blog.bruceabernethy.com:80/image.axd?picture=nxt-g_thumb.jpg</td></tr> 
    <tr><th>Physical Path</th><td>&nbsp;&nbsp;&nbsp;E:\web\agileedu\image.axd</td></tr> 
